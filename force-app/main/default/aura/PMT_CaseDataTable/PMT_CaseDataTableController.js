({
    ...
    doInit : function(component, event, helper) {
        ...
        component.set('v.columns', [          
            ...
            {label: 'Subject',fieldName: 'Subject', editable:false, type: 'text', sortable:true, cellAttributes:{class:{fieldName:'Priority'}}},
            ...
            {label: 'Opened', fieldName: 'CreatedDate', editable:false, type: 'date-local', initialWidth: 130, sortable:true,
             typeAttributes: {year: 'numeric', month: 'short', day: 'numeric'} },
            {label: 'Closed', fieldName: 'ClosedDate', editable:false, type: 'date-local', initialWidth: 130, sortable:true,
             typeAttributes: {year: 'numeric', month: 'short', day: 'numeric'} },
